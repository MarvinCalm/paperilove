...
$(window).on('scroll', function () {
   ...
   sections.each(function(i) {
    ...
    // Remove a classe 'active' de todos os itens e adiciona ao item correspondente
   ...
   ScrollReveal().reveal('.logo-name', {
     ...
     distance: '80px',  // Define a distância que o elemento vai percorrer
...
$(document).ready(function() {
    ...
    // Função de avanço automático a cada 10 segundos
